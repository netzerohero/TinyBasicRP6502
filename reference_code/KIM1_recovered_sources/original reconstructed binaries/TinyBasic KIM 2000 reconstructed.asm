...
KIMBT    = $0100		  ; Breaktest routine on low part of stack page 
;
...
BV       JMP	  KIMBT   			; KIM-1 break routine

;
; Some codes
;
BSC      .byte $5F                   ; Backspace code was $5f
LSC      .byte $18                   ; Line cancel code
PCC      .byte $84                   ; Pad character control was DEFAULT 84 (pad enabled bit 7, 4 pad characters
...
; TBIL program table
;
ILTBL    .byte $24, $3A, $80, $27, $10, $E1, $59, $C5, $2A, $56, $10, $11, $2C, $8B, $4C
